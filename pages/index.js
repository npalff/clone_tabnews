      ...
      <div>
        ...
        <p
          style={{
            ...
            fontSize: 24,
            fontFamily:
              '"Palatino Linotype","Book Antiqua",Palatino,"Apple Chancery","Segoe Script"',
            lineHeight: 1.5,
          }}
        >
          ...
          the universe”{" "}
          <a
            href="https://youtu.be/s4VIc8Qt5xM?si=Vo2EzpAuIeQxphGH"
            target="_blank"
            rel="noreferrer"
            style={{
              color: "inherit",
        ...
        >
          “Se você deseja fazer uma torta de maçã do zero, primeiro precisa
          inventar o universo.”
        </p>
      </div>
      <div
